                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <form class="d-none d-sm-inline-block form-inline mr-auto md-3 my-2 my-md-0 mw-100 py-3"
                            action="{{ @route('add.category') }}" method="POST">
                            @csrf
                            <div class="input-group">
                                <input type="text" name="category" class="form-control bg-light border-0 small"
                                    placeholder="Write Category Name" aria-describedby="basic-addon2">
